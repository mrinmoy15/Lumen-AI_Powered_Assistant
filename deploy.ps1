# deploy.ps1
# Full deploy: build image, push to Artifact Registry, and apply Terraform.
...
$tfVars = @(
    ...
    "-var", "backend_image=$FullImageName",
    "-var", "frontend_image=$FullImageName",
...
Write-Host ""
Write-Host "[BUILD] Building image: $FullImageName" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "[PUSH] Pushing to Artifact Registry..." -ForegroundColor Yellow
